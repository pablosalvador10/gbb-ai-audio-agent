...
from .key_manager import RedisKeyManager, DataType, Component
...
class AsyncAzureRedisManager:
    ...
    async def set_value(self, key: str, value: str, ttl_seconds: Optional[int] = None) -> bool:
        """
    ...
    async def update_session_field(self, session_id: str, field: str, value: str, extend_ttl: bool = True) -> bool:
        """
